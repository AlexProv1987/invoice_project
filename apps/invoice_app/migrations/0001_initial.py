    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("line_item_cnt", models.IntegerField()),
                ...
                (
                    "inv_status",
                    models.IntegerField(choices=[(1, "Billed"), (2, "Paid")]),
                ),
                ("inv_billed_date", models.DateField()),
                ("inv_paid_date", models.DateField()),
                (
                    "bus_reltn",
                    models.ForeignKey(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("file_loc", models.CharField(max_length=150)),
                (
                    "inv_reltn",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.PROTECT,
